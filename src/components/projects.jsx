    ...
    return (
      <div id='projects' className='w-full'> 
        <div className='max-w-[1240px] mx-auto px-2 py-16'>
          ...
          <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-pink-950 to-pink-400'>
            <Image
            ...
            <p className='text-center py-3 rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer m-2'>GITHUB</p>
            </Link>
            <Link href="https://shivg90.github.io/simple-js-app/">
            <p className='text-center py-3 rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer m-2'>DEMO</p>
            </Link>
           
            </div>
          </div>
          <p className='p-4 h-auto w-full shadow-sm shadow-gray-400 rounded-xl text-gray-700 text-lg'>
